...
tort_d_s(attach)
tort_d_s(backtrace)
tort_d_s(bdw_get_all_interior_pointers)
tort_d_s(bdw_get_bytes_since_gc)
tort_d_s(bdw_get_dont_expand)
tort_d_s(bdw_get_dont_precollect)
tort_d_s(bdw_get_finalize_on_demand)
tort_d_s(bdw_get_free_bytes)
tort_d_s(bdw_get_free_space_divisor)
tort_d_s(bdw_get_full_freq)
tort_d_s(bdw_get_gc_no)
tort_d_s(bdw_get_heap_size)
tort_d_s(bdw_get_java_finalization)
tort_d_s(bdw_get_max_retries)
tort_d_s(bdw_get_no_dls)
tort_d_s(bdw_get_non_gc_bytes)
