...
tort_d_m(tort__mt(fixnum), tort__s(_to_c_ptr), _tort_m_fixnum___to_c_ptr)
...
tort_d_m(tort__mt(io), tort__s(data), _tort_m_io__data)
tort_d_m(tort__mt(io), tort__s(dataSET), _tort_m_io__dataSET)
tort_d_m(tort__mt(io), tort__s(eof), _tort_m_io__eof)
tort_d_m(tort__mt(io), tort__s(error), _tort_m_io__error)
tort_d_m(tort__mt(io), tort__s(flags), _tort_m_io__flags)
tort_d_m(tort__mt(io), tort__s(flagsSET), _tort_m_io__flagsSET)
tort_d_m(tort__mt(io), tort__s(flush), _tort_m_io__flush)
tort_d_m(tort__mt(io), tort__s(fp), _tort_m_io__fp)
tort_d_m(tort__mt(io), tort__s(fpSET), _tort_m_io__fpSET)
tort_d_m(tort__mt(io), tort__s(mode), _tort_m_io__mode)
tort_d_m(tort__mt(io), tort__s(modeSET), _tort_m_io__modeSET)
tort_d_m(tort__mt(io), tort__s(name), _tort_m_io__name)
tort_d_m(tort__mt(io), tort__s(nameSET), _tort_m_io__nameSET)
...
tort_d_m(tort__mt(locative), tort__s(_object_ptr), _tort_m_locative___object_ptr)
tort_d_m(tort__mt(locative), tort__s(_ptr_data), _tort_m_locative___ptr_data)
tort_d_m(tort__mt(locative), tort__s(_to_c_ptr), _tort_m_locative___to_c_ptr)
tort_d_m(tort__mt(locative), tort__s(_to_string), _tort_m_locative___to_string)
tort_d_m(tort__mt(locative), tort__s(_word), _tort_m_locative___word)
...
tort_d_m(tort__mt(method), tort__s(lookup), _tort_m_method__lookup)
...
tort_d_m(tort__mt(nil), tort__s(_to_c_ptr), _tort_m_nil___to_c_ptr)
...
tort_d_m(tort__mt(object), tort__s(_to_c_ptr), _tort_m_object___to_c_ptr)
tort_d_m(tort__mt(object), tort__s(_to_literal), _tort_m_object___to_literal)
tort_d_m(tort__mt(object), tort__s(_to_string), _tort_m_object___to_string)
tort_d_m(tort__mt(object), tort__s(_word), _tort_m_object___word)
tort_d_m(tort__mt(object), tort__s(_word_data), _tort_m_object___word_data)
...
tort_d_m(tort__mt(object), tort__s(nullQ), _tort_m_object__nullQ)
...
tort_d_m(tort__mt(ptr), tort__s(ADD), _tort_m_ptr__ADD)
...
tort_d_m(tort__mt(ptr), tort__s(SUB), _tort_m_ptr__SUB)
...
tort_d_m(tort__mt(ptr), tort__s(_to_c_ptr), _tort_m_ptr___to_c_ptr)
tort_d_m(tort__mt(ptr), tort__s(_to_literal), _tort_m_ptr___to_literal)
tort_d_m(tort__mt(ptr), tort__s(_word), _tort_m_ptr___word)
tort_d_m(tort__mt(ptr), tort__s(nullQ), _tort_m_ptr__nullQ)
...
tort_d_m(tort__mt(tagged), tort__s(_to_literal), _tort_m_tagged___to_literal)
tort_d_m(tort__mt(tagged), tort__s(_to_string), _tort_m_tagged___to_string)
tort_d_m(tort__mt(tagged), tort__s(_word), _tort_m_tagged___word)
...
tort_d_m(tort__mt(vector), tort__s(mapE), _tort_m_vector__mapE)
...
tort_d_m(tort__mt(vector_base), tort__s(_to_c_ptr), _tort_m_vector_base___to_c_ptr)
...
tort_d_m(tort__mt(word), tort__s(ADD), _tort_m_word__ADD)
tort_d_m(tort__mt(word), tort__s(AND), _tort_m_word__AND)
tort_d_m(tort__mt(word), tort__s(DIV), _tort_m_word__DIV)
tort_d_m(tort__mt(word), tort__s(EQ), _tort_m_word__EQ)
tort_d_m(tort__mt(word), tort__s(GE), _tort_m_word__GE)
tort_d_m(tort__mt(word), tort__s(GT), _tort_m_word__GT)
tort_d_m(tort__mt(word), tort__s(INV), _tort_m_word__INV)
tort_d_m(tort__mt(word), tort__s(LAND), _tort_m_word__LAND)
tort_d_m(tort__mt(word), tort__s(LE), _tort_m_word__LE)
tort_d_m(tort__mt(word), tort__s(LOR), _tort_m_word__LOR)
tort_d_m(tort__mt(word), tort__s(LSH), _tort_m_word__LSH)
tort_d_m(tort__mt(word), tort__s(LT), _tort_m_word__LT)
tort_d_m(tort__mt(word), tort__s(MOD), _tort_m_word__MOD)
tort_d_m(tort__mt(word), tort__s(MUL), _tort_m_word__MUL)
tort_d_m(tort__mt(word), tort__s(NE), _tort_m_word__NE)
tort_d_m(tort__mt(word), tort__s(NEG), _tort_m_word__NEG)
tort_d_m(tort__mt(word), tort__s(NOT), _tort_m_word__NOT)
tort_d_m(tort__mt(word), tort__s(OR), _tort_m_word__OR)
tort_d_m(tort__mt(word), tort__s(RSH), _tort_m_word__RSH)
tort_d_m(tort__mt(word), tort__s(SUB), _tort_m_word__SUB)
tort_d_m(tort__mt(word), tort__s(XOR), _tort_m_word__XOR)
tort_d_m(tort__mt(word), tort__s(_inspect), _tort_m_word___inspect)
tort_d_m(tort__mt(word), tort__s(_to_literal), _tort_m_word___to_literal)
tort_d_m(tort__mt(word), tort__s(_to_string), _tort_m_word___to_string)
tort_d_m(tort__mt(word), tort__s(_value), _tort_m_word___value)
tort_d_m(tort__mt(word), tort__s(_word), _tort_m_word___word)
tort_d_m(tort__mt(word), tort__s(_word_data), _tort_m_word___word_data)
tort_d_m(tort__mt(word), tort__s(eqvQ), _tort_m_word__eqvQ)
...
tort_d_m(tort_h_ref(tort__mt(dynlib))->mtable, tort__s(load), _tort_M_dynlib__load)
...
tort_d_m(tort_h_ref(tort__mt(io))->mtable, tort__s(__new), _tort_M_io____new)
tort_d_m(tort_h_ref(tort__mt(io))->mtable, tort__s(__stat), _tort_M_io____stat)
tort_d_m(tort_h_ref(tort__mt(io))->mtable, tort__s(_offset_data), _tort_M_io___offset_data)
tort_d_m(tort_h_ref(tort__mt(io))->mtable, tort__s(_offset_flags), _tort_M_io___offset_flags)
tort_d_m(tort_h_ref(tort__mt(io))->mtable, tort__s(_offset_fp), _tort_M_io___offset_fp)
tort_d_m(tort_h_ref(tort__mt(io))->mtable, tort__s(_offset_mode), _tort_M_io___offset_mode)
tort_d_m(tort_h_ref(tort__mt(io))->mtable, tort__s(_offset_name), _tort_M_io___offset_name)
tort_d_m(tort_h_ref(tort__mt(io))->mtable, tort__s(new), _tort_M_io__new)
tort_d_m(tort_h_ref(tort__mt(locative))->mtable, tort__s(new_value), _tort_M_locative__new_value)
