...
tort_d_m(tort__mt(message), tort__s(fileSET), _tort_m_message__fileSET)
...
tort_d_m(tort__mt(message), tort__s(lineSET), _tort_m_message__lineSET)
...
tort_d_m(tort__mt(method), tort__s(applyfSET), _tort_m_method__applyfSET)
