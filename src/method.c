...
tort_v tort_runtime_initialize_method()
{
  ...
  tort_add_method(tort__mt(map), "size", _tort_m_map__size);
  ...
  tort_add_method(tort__mt(string), "clone", _tort_m_string__clone);
  ...
  tort_add_method(tort__mt(vector), "alloc_size", _tort_m_vector__alloc_size);
  tort_add_method(tort__mt(vector), "clone", _tort_m_vector__clone);
  ...
  tort_add_method(tort__mt(vector), "size", _tort_m_vector__size);
